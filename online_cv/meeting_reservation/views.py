...
def meeting_reservation_list(request):
    ...
    return render(request, 'reservation/meeting_reservation_list.html', {'reservations': reservations})
...
def create_meeting_reservation(request):
    ...
    return render(request, 'reservation/create_meeting_reservation.html', {'form': form})
